...
st.markdown('<div class="seccion-quejas">Quejas, sugerencias y aclaraciones, con Capitana Albatros: 8143029578</div>', unsafe_allow_html=True)            os.path.join("app", "static", nombre_archivo),
            nombre_archivo.replace(".png", ".jpg"),
            nombre_archivo.replace(".png", ".jpeg"),
            nombre_archivo.upper(),
        ]
